...
if (!current_user_can('administrator')) {
    add_action('admin_menu', 'my_remove_menu2');
}
...
//エラー対策 wlc240603
/*
 if(current_user_can('administrator') || 1!=1){
...
require_once dirname(__FILE__) . "/wlc/define.php";

function wlcConv($str)
{
    global $WWP_REPLACES;
    foreach ($WWP_REPLACES as $key => $value) {
        $str = str_replace($key, $value, $str);
    }
    return $str;
}

add_filter('the_content', 'wlcConv');
//add_shortcode( 'wlcXls', 'wlcXlsConv' );
