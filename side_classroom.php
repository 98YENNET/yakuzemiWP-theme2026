    ...
    <div class="side-menu">
        ...
        <ul class="accordion">
            ...
            <ul class="side-sub-menu">
                ...
                <li>
                    <a href="<?php echo esc_url(home_url('/')); ?>classroom/metaverse"<?php if (is_object_in_term($post->ID, 'classroom_category', 'metaverse')): ?> class="switch current" <?php else: ?> class="switch" <?php endif; ?>>メタバース教室</a>
                </li>
            </ul>
            <li>
