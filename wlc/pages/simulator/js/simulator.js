var Simulator = function () {
    ...
    self.sum = function (courseType) {
        var payment = 0;
        var courseFee = $("#simulator" + courseType).find("input[name=courseFee]:checked").val();
        ...
        var waribikiTotal = 0;
        var waribikiA = $("#simulator" + courseType).find("input[name=waribikiA]:checked").val();
        if (typeof waribikiA != "undefined") {
            waribikiA = parseInt(waribikiA);
            waribikiTotal += waribikiA;
        }
        var waribikiB = $("#simulator" + courseType).find("input[name=waribikiB]:checked").val();
        ...
        var cacheBack = 0;
        $("#simulator" + courseType).find("input[name=cb]:checked").each(function () {
