<div class="right-contents">
    ...
    <?php if (is_page(['point', 'feature', 'curriculum', 'courses-2025', 'tsugaku', 'syouninzu', 'live', 'passing', 'loan', 'simulator2025', 'benefit', 'support'])): ?>
        <div class="side-menu">
            ...
            <ul class="accordion">
                ...
                <li class="switch init-bottom <?php echo is_page(['courses-2025', 'tsugaku', 'syouninzu', 'live', 'passing']) ? 'current' : ''; ?>">
                    既卒生コース
                </li>
                <ul class="side-sub-menu">
                ...
                <li class="switch init-bottom <?php echo is_page(['loan', 'simulator2025', 'benefit']) ? 'current' : ''; ?>">
                    料金・割引・お支払い
                </li>
                <ul class="side-sub-menu">
    ...
    <?php elseif (is_page(array('message-2025', 'school-2025', 'about', 'mission', 'credo', 'sdgs', 'voices', 'globalchallenge', 'parents111'))): ?>
        <div class="side-menu">
    ...
    <?php elseif (is_page(array('remedial_omoi', 'kobetsu_voice', 'reme_contents', 'remedial', 'kobetsu_contact', 'butsuri-matsubara', 'butsuri-kamiaka', 'kagaku-tanaka', 'seibutsu-sumi', 'ph_data', 'kobetsu-koushi', 'remedial-faq'))): ?>
        <div class="side-menu">
            ...
            <ul class="accordion">
                ...
                <li class="switch init-bottom <?php echo is_page(['butsuri-matsubara', 'butsuri-kamiaka', 'kagaku-tanaka', 'seibutsu-sumi', 'remedial-faq', 'kobetsu_contact']) ? 'current' : ''; ?>">
                    勉強のコツ
                </li>
                <ul class="side-sub-menu">
                    <li>
