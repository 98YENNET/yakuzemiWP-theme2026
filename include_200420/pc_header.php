    ...
    <div class="header-wrapper">
        ...
        <div class="logo-box">
            <p class="logo"><a href="<?php echo esc_url(home_url('/')); ?>">
                ...
                </a><a href="http://www.mizuhogroup.net/" target="_blank"><img class="logo_mizuho"
                                                                               src="<?php echo get_template_directory_uri(); ?>/images/logo_mizuho-group.png"
                                                                               alt="MIZUHO Group"></a></p>
        ...
        <div class="contact-box">
            <ul>
                ...
                <li><a href="https://ph-port.jp/" target="_blank"><i class="fas fa-user"></i>卒業生・薬剤師の方</a></li>
            </ul>
        </div>
    ...
    <nav>
        <ul class="menu">
            <li class="menu__single">
                <a href="#"<?php if (is_singular('courses')): ?> class="current"<?php endif; ?>>受講案内</a>
                        ...
                        <ul class="menu__third-level">
                            ...
                            <li>
                                <a href="<?php echo esc_url(home_url('/')); ?>category/seminar_online">オンライン教室（<?php $cat = get_category_by_slug('seminar_online');
                                    echo $cat->count; ?>）</a></li>
                            <li>
                                <a href="<?php echo esc_url(home_url('/')); ?>category/seminar_remedial">リメディアル・低学年教室（<?php $cat = get_category_by_slug('seminar_remedial');
                                    echo $cat->count; ?>）</a></li>
                            <li>
        ...
        <li>
            ...
            <ul class="menu__third-level">
                ...
                <li><a href="<?php echo esc_url(home_url('/')); ?>classroom/shibuya">渋谷教室・オンライン教室</a></li>
                <li><a href="<?php echo esc_url(home_url('/')); ?>classroom/remedial">リメディアル・低学年教室</a></li>
        ...
        <li class="menu__multi">
            <a href="#"<?php if (is_page(array('exams', 'correction-exams'))): ?> class="current"<?php endif; ?>>模擬試験</a>
            <ul class="menu__second-level">
        ...
        <li class="menu__multi">
            ...
            <ul class="menu__second-level">
                ...
                <!-- 採用情報 -->
                <li>
                    <a href="<?php echo esc_url(home_url('/')); ?>candidate" class="init-right">採用情報</a>
                    <ul class="menu__third-level_right">
                        ...
                        <!-- VOICE -->
                        <li>
                            <a href="<?php echo esc_url(home_url('/')); ?>voice_001" class="init-right">講師の声</a>
                            <ul class="menu__third-level_right">
