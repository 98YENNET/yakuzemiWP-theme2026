		...
		<ul class="news">
			...
			<?php endwhile; endif;
                ...
                <section class="info-area mb50" id="lectureWrapper">
                    ...
                    <a name="calendar"></a>
                    <iframe src="https://calendar.google.com/calendar/embed?height=500&wkst=1&bgcolor=%23ffffff&ctz=Asia%2FTokyo&title=%E8%96%AC%E3%82%BC%E3%83%9F%E8%AC%9B%E7%BF%92%E4%BC%9A&showNav=1&showTz=0&showPrint=0&mode=AGENDA&src=eTRrb3N5dUB5YWt1emVtaS5hYy5qcA&src=eTVrb3N5dUB5YWt1emVtaS5hYy5qcA&src=eTZrb3N5dV9lQHlha3V6ZW1pLmFjLmpw&src=eTZrb3N5dV93QHlha3V6ZW1pLmFjLmpw&src=amEuamFwYW5lc2UjaG9saWRheUBncm91cC52LmNhbGVuZGFyLmdvb2dsZS5jb20&color=%23F09300&color=%23E4C441&color=%23356aa6&color=%23795548&color=%23009688"
        ...
        <div class="distinction-area">
            ...
            <div class="clearfix">
                <div class="distinction-area-content da01">
                    <h1><a href="<?php echo esc_url(home_url('/')); ?>courses-2024"><font
            ...
            <div class="clearfix">
                <section class="distinction-area-content da03">
                    <h1><a href="https://www.yakuzemi.ac.jp/classroom-maps/"><font size="5">全国に16教室</font></h1>
                    <div class="badge-wrapper">
                        <!--<img src="http://www2.yakuzemi.ac.jp/yz/wp-content/uploads/kyoshitsusuu.png" alt="教室数　業界NO.1" class="badge">-->
                        <img src="<?php echo get_template_directory_uri(); ?>/images/top-img03.jpg" alt="全国に16教室"
                             class="mb10"></a>
                        <p class="pickup-area-title">
        ...
        <div class="big-banner-area mb30">
            <ul>
                <li><a href="http://blog.yakuzemi.ac.jp/" target="_blank" rel="noopener"><img
                                ...
                                alt="薬ゼミブログ"></a></li>
                <li><a href="https://ph-port.jp/" target="_blank" rel="noopener"><img
                                src="http://www2.yakuzemi.ac.jp/yz/wp-content/uploads/bigbanner_Ph-port.png"
                                alt="Ph-port THINK CUBE"></a></li>
                <li><a href="https://ph-port.jp/support/thinkcube_renewal_apply" target="_blank" rel="noopener"><img
                                src="<?php echo get_template_directory_uri(); ?>/images/bigbanner_thinkcube02.png"
                                alt="THINK CUBE"></a></li>
            </ul>
        </div>
    </div>
