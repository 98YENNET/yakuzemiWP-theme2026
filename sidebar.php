<div class="right-contents">
    ...
    <?php if (is_page(['point', 'feature', 'curriculum', 'courses-2026', 'tsugaku', 'syouninzu', 'live', 'passing', 'loan', 'simulator2026', 'benefit', 'support'])): ?>
        <div class="side-menu">
            <h3 class="side_menu-title">コース案内</h3>
            <ul class="accordion">
                <li class="switch init-bottom <?php echo is_page(['point', 'feature', 'curriculum']) ? 'current' : ''; ?>">
                    私たちの特徴
                </li>
                <ul class="side-sub-menu">
                    <li><a href="<?php echo esc_url(home_url('/')); ?>point"
                           class="switch <?php echo is_page('point') ? 'current' : ''; ?>"> 私たちの特徴</a></li>
                    <li><a href="<?php echo esc_url(home_url('/')); ?>feature"
                           class="switch <?php echo is_page('feature') ? 'current' : ''; ?>"> 学生思いの講師陣</a></li>
                    <li><a href="<?php echo esc_url(home_url('/')); ?>support"
                           class="switch <?php echo is_page('support') ? 'current' : ''; ?>"> 安心の充実サポート</a>
                    </li>
                    <li><a href="<?php echo esc_url(home_url('/')); ?>curriculum"
                           class="switch <?php echo is_page('curriculum') ? 'current' : ''; ?>"> カリキュラム</a></li>
                </ul>
                <li class="switch init-bottom <?php echo is_page(['courses-2026', 'tsugaku', 'syouninzu', 'live', 'passing']) ? 'current' : ''; ?>">
                    既卒生コース
                </li>
                <ul class="side-sub-menu">
                ...
                <li class="switch init-bottom <?php echo is_page(['loan', 'simulator2026', 'benefit']) ? 'current' : ''; ?>">
                    料金・割引・お支払い
                </li>
                <ul class="side-sub-menu">
                ...
                <li><a href="https://www2.yakuzemi.ac.jp/contents/pamphlet/yakuzemi2026/" target="_blank"
                       class="switch">デジタルパンフレット</a></li>
            </ul>
        </div><!-- side-menu -->
    ...
    <?php elseif (is_page(['exams', 'acomo'])): ?>
        <div class="side-menu">
            <h3 class="side_menu-title">コース案内</h3>
            <ul class="accordion">
                <li class="switch init-bottom">私たちの特徴</li>
                <ul class="side-sub-menu">
                ...
                <li class="switch init-bottom">既卒生コース</li>
                <ul class="side-sub-menu">
                    <li><a href="<?php echo esc_url(home_url('/')); ?>courses-2026"> 既卒生コース</a></li>
                    <li><a href="<?php echo esc_url(home_url('/')); ?>tsugaku"> 通学</a></li>
                    <li><a href="<?php echo esc_url(home_url('/')); ?>syouninzu"> 少人数</a></li>
                ...
                <li class="switch init-bottom">料金・割引・お支払い</li>
                <ul class="side-sub-menu">
                    <li><a href="<?php echo esc_url(home_url('/')); ?>loan"> 料金・割引・お支払い</a></li>
                    <li><a href="<?php echo esc_url(home_url('/')); ?>simulator2026"> 受講料シミュレータ</a></li>
                    <li><a href="<?php echo esc_url(home_url('/')); ?>benefit"> 申込み・特典</a></li>
        ...
        <div class="side-menu">
            ...
            <ul class="accordion">
                ...
                <ul class="side-sub-menu">
                    <li><a href="<?php echo esc_url(home_url('/')); ?>point"> 私たちの特徴</a></li>
                    <li><a href="<?php echo esc_url(home_url('/')); ?>feature"> 学生思いの講師陣</a></li>
                    <li><a href="<?php echo esc_url(home_url('/')); ?>support"> 充実のサポート</a></li>
                    <li><a href="<?php echo esc_url(home_url('/')); ?>curriculum"> カリキュラム</a></li>
                </ul>
                <li class="switch init-bottom">既卒生コース</li>
                <ul class="side-sub-menu">
    ...
    <?php elseif (is_page(array('message', 'thought', 'about', 'mission', 'credo', 'sdgs', 'voices', 'globalchallenge', 'family-support', 'pharmacy'))): ?>
        <div class="side-menu">
            <h3 class="side_menu-title">学校情報</h3>
            <ul class="accordion">
                <li>
                    <a href="<?php echo esc_url(home_url('/')); ?>message"<?php if (is_page('message')): ?> class="switch current" <?php else: ?> class="switch" <?php endif; ?>>学長挨拶</a>
                </li>
                <li>
                    <a href="<?php echo esc_url(home_url('/')); ?>thought"<?php if (is_page('thought')): ?> class="switch current" <?php else: ?> class="switch" <?php endif; ?>>薬ゼミの思い</a>
                </li>
                <li>
                    <a href="<?php echo esc_url(home_url('/')); ?>family-support"<?php if (is_page('family-support')): ?> class="switch current" <?php else: ?> class="switch" <?php endif; ?>>ご家族向けサポート</a>
                </li>
    ...
    <?php elseif (is_page(array('remedial_omoi', 'kobetsu_voice', 'reme_contents', 'remedial', 'kobetsu_contact', 'butsuri-matsubara', 'butsuri-kamiaka', 'kagaku-tanaka', 'seibutsu-sumi', 'ph_data', 'kobetsu-koushi', 'remedial-faq'))): ?>
        <div class="side-menu">
            ...
            <ul class="accordion">
                <li class="switch init-bottom <?php echo is_page(['remedial', 'kobetsu-koushi', 'kobetsu_voice']) ? 'current' : ''; ?>">
                    個別指導について
                </li>
                <ul class="side-sub-menu">
                    <li>
                ...
                <li>
                    <a href="<?php echo esc_url(home_url('/')); ?>kobetsu_contact"<?php if (is_page('kobetsu_contact')): ?> class="switch current" <?php else: ?> class="switch" <?php endif; ?>>お問い合わせ</a>
            </ul>
        </div><!-- side-menu -->
