    ...
    <div class="page-contents">
        ...
        <div class="left-contents">
            ...
            <article class="post">
                ...
                <img src="<?php echo WWP_THEME_URI; ?>/wlc/pages/<?php echo $dir; ?>/supportersmap.png"
                     usemap="#ImageMap" alt="" width="951" height="888"/>
                <map name="ImageMap">
                ...
                <ul class='supporters2020'>
                    <li class=''><a
                                href="https://www.yakuzemi.ac.jp/supporters_seminar/">埋め本・薬学生のための計算問題集協賛企業の一覧はこちら</a>
                    </li>
                </ul>
                <?php
                ...
                $filepath = dirname(__FILE__) . "/wlc/pages/" . $dir . "/list.txt";
